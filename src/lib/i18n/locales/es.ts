...
export const es: Messages = {
  ...
  invite: {
    ...
    subtitle: 'Invitación a "{room}"',
    linkLabel: "Enlace de invitación",
    copyLink: "Copiar enlace",
    share: "Compartir",
    qrLabel: "Invitar con código QR",
    qrHint: "Escanéalo con la cámara del móvil para abrir esta sala.",
    qrAlt: 'Código QR del enlace de invitación a "{room}"',
    roomIdLabel: "ID de sala",
    friendsTitle: "Enviar a un amigo",
    friendsEmpty: "Aún no tienes amigos",
    send: "Enviar",
    sending: "Enviando…",
    sent: "Enviado",
    sendFailed: "No se pudo enviar la invitación",
    dmBody: 'Te invito a "{room}"\n{url}',
    hint: "Cualquiera que tenga este enlace (o el ID de la sala) puede entrar. Compártelo solo con gente de confianza.",
    inviteAction: "Invitar a esta sala",
    bannerInvited: 'Te han invitado a "{room}"',
  ...
  personal: {
    title: "Mis notas",
    subtitle: "Se guardan solo en este dispositivo",
    privacyNote:
      "Nada de lo que escribas aquí se envía a nadie. A diferencia de las otras salas, no hay transmisión ni sincronización: se queda en este dispositivo.",
    empty: "Todavía no hay notas. Anota lo que se te ocurra.",
    composerPlaceholder: "Escribe una nota…",
    send: "Guardar",
    attach: "Adjuntar un archivo",
    attachHint: "Puedes adjuntar una imagen, un video o cualquier archivo",
    edited: "editada",
    ...
    loading: "Cargando…",
    attachmentFailed: "No se pudo cargar el archivo adjunto",
    errLoad: "No se pudieron cargar tus notas. Intenta recargar la página.",
    errSave: "No se pudo guardar la nota — puede que el almacenamiento no esté disponible.",
    errAttach: "No se pudo adjuntar ese archivo.",
  },
};
