...
export const fr: Messages = {
  ...
  personal: {
    title: "Mes notes",
    subtitle: "Enregistrées sur cet appareil uniquement",
    privacyNote:
      "Rien de ce que tu écris ici n'est envoyé à qui que ce soit. Contrairement aux autres salons, il n'y a ni transmission ni synchronisation : tout reste sur cet appareil.",
    empty: "Aucune note pour l'instant. Note ce qui te passe par la tête.",
    composerPlaceholder: "Écris une note…",
    send: "Enregistrer",
    attach: "Joindre un fichier",
    attachHint: "Tu peux joindre une image, une vidéo ou n'importe quel fichier",
    edited: "modifiée",
    ...
    loading: "Chargement…",
    attachmentFailed: "Impossible de charger la pièce jointe",
    errLoad: "Impossible de charger tes notes. Essaie de recharger la page.",
    errSave: "Impossible d'enregistrer la note — le stockage est peut-être indisponible.",
    errAttach: "Impossible de joindre ce fichier.",
  },
};
