...
export const ko: Messages = {
  ...
  invite: {
    ...
    share: "공유",
    qrLabel: "QR 코드로 초대",
    qrHint: "휴대폰 카메라로 스캔하면 이 방이 열려요.",
    qrAlt: "'{room}' 초대 링크의 QR 코드",
    roomIdLabel: "방 ID",
    friendsTitle: "친구에게 보내기",
    friendsEmpty: "아직 친구가 없어요",
    send: "보내기",
    sending: "보내는 중…",
    sent: "보냄",
    sendFailed: "초대를 보내지 못했어요",
    dmBody: "'{room}'에 초대할게요\n{url}",
    hint: "이 링크(또는 방 ID)를 아는 사람은 누구나 이 방에 참가할 수 있어요. 믿을 수 있는 사람에게만 공유하세요.",
    inviteAction: "이 방에 초대",
    bannerInvited: "'{room}'에 초대받았어요",
  ...
  personal: {
    title: "내 메모",
    subtitle: "이 기기에만 저장돼요",
    privacyNote:
      "여기에 쓴 내용은 누구에게도 전송되지 않아요. 다른 방과 달리 통신도 동기화도 하지 않고, 이 기기 안에만 저장돼요.",
    empty: "아직 메모가 없어요. 떠오르는 것을 편하게 적어 두세요.",
    composerPlaceholder: "메모를 입력하세요…",
    send: "저장",
    attach: "파일 첨부",
    attachHint: "이미지, 동영상, 파일을 첨부할 수 있어요",
    edited: "수정됨",
    editNote: "메모 수정",
    deleteNote: "메모 삭제",
    deleteConfirmTitle: "이 메모를 삭제할까요?",
    deleteConfirmBody: "삭제하면 되돌릴 수 없어요.",
    captionPlaceholder: "설명 (선택)",
    loading: "불러오는 중…",
    attachmentFailed: "첨부 파일을 불러올 수 없어요",
    errLoad: "메모를 불러올 수 없어요. 페이지를 새로고침해 보세요.",
    errSave: "메모를 저장할 수 없어요. 저장 공간을 사용할 수 없을 수 있어요.",
    errAttach: "파일을 첨부할 수 없어요.",
  },
};
